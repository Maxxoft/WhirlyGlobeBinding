...
namespace WhirlyGlobeMaply
{
    ...
    interface MaplyScreenMarker
    {
        ...
        MaplyCoordinate Location { get; set; }
    ...
    interface MaplyBaseViewController
    {
        ...
        // -(void)addLight:(MaplyLiAnimateToPositionght *)light;
        [Export("addLight:")]
    ...
    interface MaplyElevationDatabase : MaplyElevationSourceDelegate
    {
        ...
        // -(MaplyElevationChunk *)elevForTile:(MaplyTileID)tileID;
        [Export("elevForTile:")]
        new MaplyElevationChunk ElevForTile(MaplyTileID tileID);
    }
    ...
    [Protocol]
    [BaseType(typeof(MaplyBaseViewController), Name = "WhirlyGlobeViewController")]
